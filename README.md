...
### Configure Firebase/Google Analytics for each native project of Flutter app
...
- Firebase Analytics requires native projects to be configured, not the Dart part. I.e. various plists for macOS/iOS, .js file for web et.c
